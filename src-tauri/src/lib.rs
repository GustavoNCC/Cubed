...
use cubed_infrastructure::{
    check_integrity, FileBackupManager, FileModManager, InMemoryBackupRepo, InMemoryModpackRepo,
    InMemoryModRepo, JsonServerRepository, LocalFileSystem, MinecraftConsoleManager,
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            std::fs::create_dir_all(&data_dir)
                .expect("No se puede crear el directorio de datos");
